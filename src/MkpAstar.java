...
public class MkpAstar {
    ...
    public static void main(String[] args) {//////////////////////////////////////////////////////////////
        ...
        Retresult1 result = Starsolver(node,items.size(),sacs,items,bestcombo,Bestbenef);
    ...
    static Retresult1 Starsolver(Obj1 startNode ,int limit, List<Sac> sacs,List<Item> items, List<Obj1> bestcombo,int Bestbenef ) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (Sac sac : sacs) {
                    ...
                    Obj1 node = new Obj1(sac,items.get(currentNode.profondeur) , currentNode.g+items.get(currentNode.profondeur).poids,currentNode.profondeur+1,items.size()-currentNode.profondeur);
    ...
    static int verifySolution(List<Obj1> currentPath,List<Sac> sacs,List<Item> items) {
        ...
        for (Obj1 obj : currentPath) {
            ...
            // System.out.println(" S:" + obj.sac.nom  +  "I:"+obj.item.nom + "\n");
                ...
                // for (Sacwheight sacw : sacswheit) {
                //     System.out.println("S:"+sacw.sac.nom + "  W:" + sacw.wheight);
                // }
                // System.out.println("_______________________________________________");
